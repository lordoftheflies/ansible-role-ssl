...
Ssl is an Ansible Role used to setup and maintain production grade services.
...
* [On Ansible Galaxy](https://galaxy.ansible.com/lordoftheflies/ansible_role_ssl)
...
* [example_ssl.yml](files/example_site.yml) may contain an example entry.
...
* ssl generated using [ansible_collection_skeleton](https://github.com/<class 'jinja2.utils.Namespace'>/ansible_collection_skeleton)
[![Ansible Role](https://img.shields.io/ansible/role/d/)](https://galaxy.ansible.com/lordoftheflies/ansible_role_ssl)
[![Ansible Role](https://img.shields.io/ansible/role/)](https://galaxy.ansible.com/lordoftheflies/ansible_role_ssl)
